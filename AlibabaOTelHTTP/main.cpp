...
// Removed: #include "opentelemetry/sdk/resource/semantic_conventions.h"
// The semantic conventions are now accessed directly as string literals or through other specific headers/namespaces.
#include "opentelemetry/sdk/resource/resource.h" // Include this for opentelemetry::sdk::resource::Resource
...
namespace
{
    ...
    void InitTracer()
    {
        ...
        // Use string literals for semantic convention keys directly.
        // The old semantic_conventions.h header is deprecated.
        resource::ResourceAttributes attributes = {
                {"service.name", "${ServiceName}"}, // The application name.
                {"host.name", "${HostName}"}
        };
