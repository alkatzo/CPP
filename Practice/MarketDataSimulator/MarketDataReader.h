...
// Market data reader with statistics display
...
public:
    // Constructors
    MarketDataReader(SynchronizedQueue<LockStrategy>& q);
    MarketDataReader(const MarketDataReader&) = delete;  // thread is not copyable
    MarketDataReader(MarketDataReader&&) = delete;       // thread is not movable
    
    // Assignment operators
    MarketDataReader& operator=(const MarketDataReader&) = delete;  // thread is not copyable
    MarketDataReader& operator=(MarketDataReader&&) = delete;       // thread is not movable
